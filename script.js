document.addEventListener('DOMContentLoaded', function () {
    ...
    const messages = [
        ...
        "周六那天，我当时认真考虑了你刚刚说到的学历问题。我们相处了一个月，因为我们聊的投缘，所以我的心里一直认为你是个很棒的姑娘。我没有有色眼睛，我只在乎我对你的感觉。当时想到这里，我觉得你是不是也应该了解我的另一面看你能不能像我一样接纳，所以我想跟你慢慢来，让我们都能试着接纳彼此的不那么优秀的地方。但是，我自从牵完你的手后再和你聊就开始畏首畏尾，职业习惯总感觉你像监考老师一样给我的一言一行打分。",
