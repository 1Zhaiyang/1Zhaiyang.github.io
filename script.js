document.addEventListener('DOMContentLoaded', function () {
    ...
    const messages = [
        "这是周六日两天我准备的礼物，还没把页面优化到最好，本想慢慢完善下，时机成熟了用pad当面给你播放，但是没机会啦。信的内容我做了修改刚刚，改成了最后想跟你说的话。其他的图片炫彩我都没有时间改啦，明早要投入工作了，这个就当作是我们临别的礼物送给你！这个礼物本来是表白的话，毕竟吸收了上次牵你手不会说话的经验，这次我就提前准备啦，不过内容我就改了，说一些最后想说的话，关于你说的自己的平凡",
        "周六那天，我当时认真考虑了你刚刚说到的学历问题。我们相处了一个月，因为我们聊的投缘，所以我的心里一直认为你是个很棒的姑娘。我没有有色眼睛，我只在乎我对你的感觉。当时想到这里，我觉得你是不是也应该了解我的另一面看你能不能像我一样接纳，所以我想跟你慢慢来，让我们都能试着接纳彼此的不那么优秀的地方。但是，我自从牵完你的手后再和你聊就开始畏首畏尾，我不知道我们之后慢慢进一步熟悉彼此的过程我还要束手束脚到多会。",
        ...
        "于是就有了今晚我跟你发的消息，我把我所有的缺点都告诉你，就是不给自己未来的遮掩畏缩留退路，我已经把我所有的不想告诉你的都告诉你了，未来我要麻痹自己，大大方方给你展示我的每一面，如果你像当时周六的我一样能够接受我的可能不是很优秀的一面，那我们一定会有未来。哈哈哈哈哈哈哈，现在想想我也觉得没错，但结果证明确实搞砸了。",
        "最后说的这些，希望你能理解，你的学历工作能力什么的都不值得你焦虑，这些都是很无关紧要的东西，你有你的光芒，你能够发现书呆子发现不了的美丽世界，你拥有大部分人没有的共情能力和给人带来的温暖舒适感。未来肯定有人能够发现你的这些闪光点，在这些闪光点面前，你所吐槽的你的那些缺点根本无关紧要。困了，语无伦次了",
