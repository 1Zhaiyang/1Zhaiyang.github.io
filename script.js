document.addEventListener('DOMContentLoaded', function () {
    ...
    const messages = [
        ...
        "周五那天，我想过你刚刚说到的学历问题。你告诉我之后我们在地铁横向移动的时候，我脑子里一直回想那天晚上九点多我跟你讲我在论文里看到的博弈论的思想而你也get到其中警匪精妙博弈的那件事，我当时就觉得学历在思维同频面前毫不重要。我们相处了一个月，因为我们聊的投缘，我的心里一直认为你是个对新生物充满学习欲望的姑娘。我从来没有有色眼镜，我只在乎我的亲眼所见和真实感受。当时想到这里，我觉得你是不是也应该了解我的另一面看看你能不能像我一样接纳彼此的不足，所以我决定跟你拉长战线慢慢来，让我们都能试着接纳彼此的不那么优秀的地方。但是，自从牵完你的手后再和你聊就开始畏首畏尾，学生当久了总感觉你像监考老师一样给我接下来的一言一行打分。",
        ...
        "最后说的这些，希望你能理解，你的学历工作能力什么的都不值得你焦虑，这些都是很无关紧要的东西。你对我没感觉我都不觉得我有啥大问题(hhh)，我反而觉得是缘分和小细节问题，你还有什么值得自我否定的呢是不。你有你的光芒，你能够发现书呆子发现不了的美丽世界，你拥有大部分人没有的共情能力，你也能给人带来无与伦比的温暖舒适感。未来肯定还有其他人能够发现你的这些闪光点，在这些闪光点面前，你所吐槽的你的那些缺点根本无关紧要。困了，语无伦次了。这些背景都是周六日抽空做的，困得我也不改啦，代码很繁琐，但都是曾经的心意，交给你了，我也准备轻装上路",
        "命运真的神奇，打死我也想不到周六搭起来的准备将来表白的背景，现在被临别赠言填满了。叭叭叭半天，情绪也释放了(好像咱俩见面我滔滔不绝一顿输出然后回来很快乐那种感觉)。冷静下来，我也有问题，要是真会表达喜欢，那我早就得到你的否决及时止损啦。不过山一程水一程，一程有一程的惊喜。还是很幸运遇到你，不检查了，不知道上面有多少语病和错字，太困了",
        "不写啦，12：37了，要早点睡觉了。谢谢你出现在我的旅途里，没能实现带你游历祖国的愿望，平行时空里的我说不定做到了。虽然今日之后我们的世界再无交集，但我相信你我的人生都会很灿烂。最后，如果可以，你可以列出我的问题，我不会纠缠打扰，但会认真读完从这段失败的经历中汲取教训。再见啦！",
        // 可以根据需要添加更多段落
    ];
    let pageIndex = 0;
    let charIndex = 0;
